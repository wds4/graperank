...
https://graperank.tech/api/nostr/listeners/latestUpdates?t=3600
...
export default async function handler(
  ...
  try {
    ...
    sub1.on('eose', async () => {
      ...
      const response = {
        success: true,
        message: `api/tests/listeners/latestUpdates eose!`,
        data: {
          receivedEvents,
        }
      }
    ...
    const response = {
      success: false,
      message: `api/tests/listeners/latestUpdates error: ${e}`
    }
